$(document).ready(
    ...
    function () {
        function addNew(itemId, itemClass){
            console.log(itemId + "and "+ itemClass);
            var Item = {
                NEWS_ITEM :         '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                            ...
                            <div class="form-group">\
                                ...
                                <textarea id="news_textarea_'+itemId+'" class = "form-control" name="news_content"></textarea>\
                            </div>\
                            <div class="form-group">\
                ...
                RESEARCH_ITEM : '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                            ...
                            <div class="form-group">\
                                ...
                                <textarea id="research_textarea_'+itemId+'" class = "form-control" name="research_desc"></textarea>\
                            </div>\
                            <div class="form-group">\
                                <input type="hidden" name="date" value="2014-05-28 00:00:00"/>\
                ...
                RESOURCE_ITEM : '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                            ...
                            <div class="form-group">\
                                <label for="description">Description:</label>\
                                <textarea id="resources_textarea_'+itemId+'" class = "form-control" name="res_desc"></textarea>\
                            </div>\
                            <div class="form-group">\
                                <input type="hidden" name="date" value="2014-05-28 00:00:00"/>\
                ...
                COURSE_ITEM : '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                        ...
                        <div class="form-group">\
                            <label for="description">Description:</label>\
                            <textarea id="courses_textarea_'+itemId+'" class = "form-control" name="cos_desc"></textarea>\
                        </div>\
                        <div class="form-group">\
                ...
                PROGRAM_ITEM : '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                        ...
                        <div class="form-group">\
                            <label for="details">Details:</label>\
                            <textarea id="prog_textarea_'+itemId+'" class = "form-control" name="prog_details"></textarea>\
                        </div>\
                        <div class="form-group">\
                ...
                STAFF_ITEM :    '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                        ...
                        <div class="form-group">\
                            ...
                            <textarea id="staff_textarea_'+itemId+'" class = "form-control" name="staff_details"></textarea>\
                        </div>\
                ...
                STUDENT_GROUP_ITEM :    '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                                ...
                                <div class="form-group">\
                                    <label for="description">Description:</label>\
                                    <textarea id="stud_group_textarea_'+itemId+'" class = "form-control" name="student_desc"></textarea>\
                                </div>\
                ...
                ALUMNI_ITEM : '<form role="form" enctype="multipart/form-data" method="POST" action="dbEntry.php">\
                        ...
                        <div class="form-group">\
                            <label for="description">Description:</label>\
                            <textarea id="alumni_textarea_'+itemId+'" class = "form-control" name="alumni_desc"></textarea>\
                        </div>\
                        <input type="hidden" name="staff_cat" value="alumni"/>\
                        <input type="hidden" name="all_forms" value="people"/></form>'
            };
            var text;
            $('<div>',{'id':itemId,class:itemClass}).appendTo('#'+itemClass+'.conDiv');
            if(itemClass == 'news'){
                text = Item.NEWS_ITEM;
            }else if(itemClass == 'research'){
                text = Item.RESEARCH_ITEM;
            }else if(itemClass == 'resources'){
                text = Item.RESOURCE_ITEM;
            }else if(itemClass == 'courses'){
                text = Item.COURSE_ITEM;
            }else if(itemClass == 'prog'){
                text = Item.PROGRAM_ITEM;
            }else if(itemClass == 'staff'){
                text= Item.STAFF_ITEM;
            }else if(itemClass=='stud_group'){
                text = Item.STUDENT_GROUP_ITEM;
            }else if(itemClass = 'alumni'){
                text = Item.ALUMNI_ITEM;
            }
            $(text).appendTo('#'+itemId+'.'+itemClass);
            var v = $('#'+itemId+'.'+itemClass).find('textarea');
            $(v).addClass('ck'+itemId)
            CKEDITOR.replace($(v).attr('id'));
            $('<div>',{'id':itemId,class:'cBlock','text':itemId}).appendTo('#'+itemClass+'.holder');
        }
